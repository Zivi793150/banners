...
export type TableKind = 'little' | 'big' | 'mid' | 'home-roster' | 'away-roster' | 'roster' | 'scoreboard' | 'scoreboard-top' | 'person' | 'replace' | 'off';
...
export type Scenario = 'begin' | '1' | '2' | 'pause' | 'end' | 'VAR' | 'out' | 'penalty';
...
export const table_kinds = ['big', 'little', 'mid', 'home-roster', 'away-roster', 'roster', 'scoreboard', 'scoreboard-top', 'person', 'replace', 'off'];
